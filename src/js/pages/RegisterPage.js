              ...
              <div className="row" data-spIf="!account.created">
                <div className="col-xs-12">
                  <div className="form-horizontal">
                    ...
                    <div className="form-group">
                      <label htmlFor="customData.zipcode" className="col-xs-12 col-sm-4 control-label">zipcode</label>
                      <div className="col-xs-12 col-sm-4">
                        <input type="text" className="form-control" id="customData.zipcode" name="customData.zipcode" placeholder="H2X1V9" />
                      </div>
                    </div>
                    <div className="form-group">
